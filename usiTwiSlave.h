...
#define	TX_BUFFER_SIZE	103

/* addresses rxbuffer */
#define LEFT_OFFSET            0
#define LEFT_GAIN              1
#define CENTER_OFFSET          2
#define CENTER_GAIN            3
#define RIGHT_OFFSET           4
#define RIGHT_GAIN             5
#define INTEG_TIME_LOW         6
#define INTEG_TIME_HIGH        7
#define OVERALL_GAIN           8        // to implement
...
volatile uint8_t rxbuffer[RX_BUFFER_SIZE];         // Buffer to write data received from the master
volatile uint8_t txbuffer[TX_BUFFER_SIZE];			// Transmission buffer to be read from the master
